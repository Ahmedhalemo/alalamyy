...
if tonumber(user_id) =1186900224= tonumber(424594065) then  
var = 'مطور السورس'
elseif tonumber(user_id) =1377559539= tonumber(SUDO) then
var = 'مطور السورس'  
elseif tonumber(user_id) =1219803548= tonumber(bot_id) then  
var = 'البوت'
elseif database:sismember(bot_id..'Sudo:User', user_id) then
...
send(msg.chat_id_, msg.id_,' ✸∫ تم تحديث السورس \n ✸∫ لديك اخر اصدار لسورس العالمي
م\n ✸∫ الاصدار » { 1.3v}')
dofile('Kulkom.lua')  
end
if text == 'الاصدار ✸' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✸∫ اصدار سورس العالمي\n ✸∫ الاصدار »{ 1.3v}')
end
...
send(msg.chat_id_,0," ✸∫ عذرا » {["..data.first_name_.."](T.ME/FlasaTas10)}\n ✸∫ عذرا تم منع المتحركه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
os.execute('rm -rf Kulkom.lua')
os.execute('wget https://raw.githubusercontent.com/TeAmKulkom/Kulkom/master/Kulkom.lua')
send(msg.chat_id_, msg.id_,' ✸∫ تم تحديث السورس \n ✸∫ لديك اخر اصدار لسورس العالمي  م\n ✸∫ الاصدار » { 1.3v}')
dofile('Kulkom.lua')  
end
...
≪━━━━━━━━━━━━━≫
 ✸∫ ↬[The way his inauguration](https://t.me/FlassTas10)
≪━━━━━━━━━━━━━≫
 ✸∫ ↬[To talk to us](t.me/FlassTas4_bot )
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if Get_info then
local TextS = "\n ✸∫ اهلا بك في متجر ملفات العالمي \n ✸∫ ملفات السورس ↓\n≪━━━━━━━━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━━━━━━━━≫\n ✸∫ علامة تعني { ✓ } ملف مفعل\n ✸∫ علامة تعني { ✘ } ملف معطل\n ✸∫ قناة سورس العالمي م↓\n".." ✸∫ [اضغط هنا لدخول](t.me/FlassTas10) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ✸∫ عذرا الملف لايدعم سورس العالمي م\n") 
end
return false
end
...
*✸م10 ◂ اوامر الاعضاء*
ٴ≪━━━━━━𝒔𝒐𝒖𝒓𝒄𝒆 𝒂𝒍𝒂𝒎𝒚 ♕━━━━━━≫ٴ
彡 .[Kulkom 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/FlassTas10)➢ 
]]
