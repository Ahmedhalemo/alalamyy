...
var = 'مطور اساسي'
elaeif UserID == 1186900224 then
var = 'مطور سورس' 
elaeif UserID == 1377559539 then
var = 'مطور سورس'
elseif database:sismember(bot_id.."Tshake:Sudo:User", user_id) then
...
local Num_Games = database:get(bot_id.."Tshak:Msg_User"..msg.chat_id_..":"..data.id_) or 0
local Add_Mem = database:get(bot_id.."Tshake:Add:Memp"..msg.chat_id_..":"..data.id_) or 0
send(msg.chat_id_, msg.id_,'*⇒🇪🇬 𝒊𝒅 '..Id..'\n⇒ 🇪🇬 𝒎𝒔𝒈𝒔 - '..NumMsg..'\n⇒ 🇪🇬𝒖𝒔𝒆𝒓 - *['..UserName_User..']*\n⇒𝒕𝒂𝒇𝒂𝒆𝒖𝒍𝒖𝒉 🇪🇬 '..TotalMsg..'\n⇒ 🇪🇬 𝒔𝒕𝒂𝒔𝒕 '..Status_Gps..'\n⇒ 🇪🇬𝒉𝒊𝒔 𝒂𝒅𝒋𝒖𝒔𝒕𝒎𝒆𝒏𝒕𝒔 '..message_edit..'\n⇒ 🇪🇬𝒅𝒆𝒔𝒕𝒊𝒏𝒂𝒕𝒊𝒐𝒏𝒔 '..Add_Mem..'*') 
end,nil)   
else
send(msg.chat_id_, msg.id_,'👤┇لا يوجد حساب بهاذا المعرف')
end
...
↯┇ 𝒔𝒐𝒖𝒓𝒄𝒆 𝒂𝒍𝒂𝒎𝒚 ♕
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
↯┇ [Source Channel](https://t.me/FlassTas10)

↯┇ [𝒅𝒆𝒗 𖤍](https://t.me/Alamy3)

↯┇ [𝒅𝒆𝒗 𖤍](https://t.me/XxxMalificentxxX)

 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
↯┇ [TWS TshAkE](https://t.me/FlassTas4_bot)
]]
send(msg.chat_id_, msg.id_,Text)
end
