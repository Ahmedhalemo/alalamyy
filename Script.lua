...
redis:set(Alamy.."getidstatus"..msg.chat_id_, "Simple")
...
redis:set(Alamy..'lock:join:'..msg.chat_id_,true)
...
redis:del(Alamy..'lock:join:'..msg.chat_id_)
return "*➪ ** أهلا عزيزي *"..msg.TheRankCmd.."*\n➪ ** تم فتح الدخول بالرابط \n*" 
end


local function izoro(msg,MsgText)

Channel = redis:get(Alamy..'setch') or katrenno
--JoinChannel
function is_JoinChannel(msg)
if redis:get(Alamy..'joinchnl') then
...
redis:set(Alamy.."getidstatus"..msg.chat_id_, "Photo")
redis:set(Alamy..'lock:kara:'..msg.chat_id_,'off')
return modadd(msg)  
end
...
redis:setex(Alamy..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(Alamy..'CheckExpire::'..msg.chat_id_) then 
redis:set(Alamy..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'➪│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... ➪')
sendMsg(SUDO_ID,0,'➪│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... ➪\n➪│في مجموعه  » »  '..redis:get(Alamy..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "➪*│*هذا الامر يخص {المطور} فقط  \n➪" end
if MsgText[2] == '1' then
redis:setex(Alamy..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(Alamy..'CheckExpire::'..msg.chat_id_) then 
redis:set(Alamy..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم تفعيل الاشتراك   👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم تفعيل الاشتراك  👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(zoro..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(zoro..'CheckExpire::'..msg.chat_id_) then 
redis:set(zoro..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم تفعيل الاشتراك   👍🏿\n📆│ الاشتراك » `90 يوم`  *(3 اشهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم تفعيل الاشتراك   👍🏿\n📆│ الاشتراك » `90 يوم`  *(3 اشهر)*')
end
if MsgText[2] == '3' then
redis:set(Alamy..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(Alamy..'CheckExpire::'..msg.chat_id_) then 
redis:set(Alamy..'CheckExpire::'..msg.chat_id_,true) end
...
local check_time = redis:ttl(zoro..'ExpireDate:'..msg.chat_id_)
...
local GroupName = (redis:get(Alamy..'group:name'..msg.chat_id_) or '')
redis:set(Alamy..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
users = redis:get(zoro..'user_names:'..v.user_id_) or v.user_id_
x = x + 1
...
if not msg.Director then return "➪ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. Alamy..'')
...
if not msg.Director and redis:get(Alamy..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(zoro..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
...
if not msg.Admin then return "➪ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not MsgText[2] and msg.reply_id then
if redis:get(Alamy..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(Alamy..'lock:kara:'..msg.chat_id_) == 'on' then
...
if not MsgText[2] and msg.reply_id then
if redis:get(zoro..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(zoro..'lock:kara:'..msg.chat_id_) == 'on' then
...
local Admins = redis:scard(Alamy..'admins:'..msg.chat_id_)
redis:del(Alamy..'admins:'..msg.chat_id_)
local NumMDER = redis:scard(Alamy..'owners:'..msg.chat_id_)
redis:del(Alamy..'owners:'..msg.chat_id_)
local MMEZEN = redis:scard(Alamy..'whitelist:'..msg.chat_id_)
redis:del(Alamy..'whitelist:'..msg.chat_id_)
...
if not msg.Director then return "➪ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(Alamy..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(Alamy..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(Alamy..'ExCmdLink'..msg.chat_id_,120,true)
...
if not msg.Director then return "➪ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(Alamy..'linkGroup'..msg.sender_user_id_,300,true)
return '• عزيزي قم برسال الرابط الجديد ...➪'
end

if MsgText[1] == "الرابط" then
if not redis:get(zoro..'linkGroup'..msg.chat_id_) then 
return "• ** اوه لا يوجد رابط .\n• **لانشاء رابط ارسل { `انشاء رابط` }\n" 
end
local GroupName = redis:get(Alamy..'group:name'..msg.chat_id_)
local GroupLink = redis:get(Alamy..'linkGroup'..msg.chat_id_)
...
local Text = "➪ رابـط الـمـجـمـوعه ➪ \n"..Flter_Markdown(redis:get(Alamy..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
redis:set(Alamy..'flood'..msg.chat_id_,MsgText[2]) 
...
if not msg.Director then return "➪ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Mn3Word = redis:scard(Alamy..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "➪ ** عذراً لا توجد كلمات ممنوعه ليتم حذفها" 
end
redis:del(Alamy..':Filter_Word:'..msg.chat_id_)
...
if not msg.Director then return "➪ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(Alamy..'rulse:msg'..msg.chat_id_) then 
return "➪ عذراً لا يوجد قوانين ليتم مسحه \n!" 
end
redis:del(Alamy..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "➪ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(Alamy..'welcome:msg'..msg.chat_id_) then 
return "➪ ** اوه هنالك خطأ .\n➪ عذراً لا يوجد ترحيب ليتم مسحه ." 
end
redis:del(Alamy..'welcome:msg'..msg.chat_id_)
...
if not msg.SudoUser then return "➪ **هذا الامر يخص {المطور} فقط  \n" end
local NumMnsha = redis:scard(Alamy..':Hussain:'..msg.chat_id_)
redis:del(Alamy..':Hussain:'..msg.chat_id_)
...
if not msg.Kara then return "➪¦  **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local NumMnsha = redis:scard(Alamy..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "عذرا لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(Alamy..':MONSHA_BOT:'..msg.chat_id_)
return " أهلا عزيزي "..msg.TheRankCmd.."   \n تم مسح {* "..NumMnsha.." *} من المنشئيين\n"
end


if MsgText[2] == "المدراء" then
if not msg.Creator then return "Alamy **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local NumMDER = redis:scard(Alamy..'owners:'..msg.chat_id_)
if NumMDER ==0 then 
return "• عذراً لا يوجد مدراء ليتم مسحهم \n!" 
end
redis:del(Alamy..'owners:'..msg.chat_id_)
return "Alamy **أهلا عزيزي "..msg.TheRankCmd.."   \n➪ تم مسح {* "..NumMDER.." *} من المدراء  \n"
end

if MsgText[2] == 'المحظورين' then
if not msg.Director then return "➪ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end

local list = redis:smembers(Alamy..'banned:'..msg.chat_id_)
if #list == 0 then return "*➪ لا يوجد مستخدمين محظورين  *" end
message = '➪ ** قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end 
redis:del(Alamy..'banned:'..msg.chat_id_)
return "➪ **أهلا عزيزي "..msg.TheRankCmd.."   \n➪  تم مسح {* "..#list.." *} من المحظورين  \n"
end

if MsgText[2] == 'المكتومين' then
if not msg.Director then return "• **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local MKTOMEN = redis:scard(zoro..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "• ** لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(zoro..'is_silent_users:'..msg.chat_id_)
return "• **أهلا عزيزي "..msg.TheRankCmd.."   \n• تم مسح {* "..MKTOMEN.." *} من المكتومين  \n"
end

if MsgText[2] == 'المقييدين' then
if not msg.Director then return "• **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local MMEZEN = redis:scard(Alamy..'whitelist:'..msg.chat_id_)
if MMEZEN ==0 then 
return "*• *لا يوجد مستخدمين المقييدين في المجموعه " 
end
redis:del(Alamy..'whitelist:'..msg.chat_id_)
return "• **أهلا عزيزي "..msg.TheRankCmd.."   \n• تم مسح {* "..MMEZEN.." *} من المقييدين  \n"
end


if MsgText[2] == 'الرابط' then
if not msg.Director then return "➪ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(Alamy..'linkGroup'..msg.chat_id_) then
return "*➪ *لا يوجد رابط مضاف اصلا " 
end
redis:del(Alamy..'linkGroup'..msg.chat_id_)
...
if not msg.Creator then return "➪ **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(Alamy..'name:witting'..msg.sender_user_id_,300,true)
...
redis:setex(zoro..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Creator then return "➪ **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(Alamy..'about:witting'..msg.sender_user_id_,300,true) 
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(Alamy..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(Alamy..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(Alamy..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(Alamy..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
if redis:get(Alamy..'lock_id'..msg.chat_id_) then 
local msgs = redis:get(Alamy..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
...
local rfih = (redis:get(Alamy..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local NumGha = (redis:get(Alamy..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local Namei = FlterName(data.first_name_..' '..(data.last_name_ or ""),20)
GetPhotoUser(msg.sender_user_id_,function(arg, data)
if redis:get(Alamy.."getidstatus"..msg.chat_id_) == "Photo" then
	if data.photos_[0] then 
		...
		sendPhoto(msg.chat_id_,msg.id_,data.photos_[0].sizes_[1].photo_.persistent_id_,'- 🇪🇬 𝒖𝒔𝒆𝒓𝒏𝒂𝒎𝒆 𖣂   '..Namei..'     \n- 🇪🇬 𝒖𝒔𝒆𝒓   𖣂 '..UserNameID..' .\n- 🇪🇬 𝒎𝒔𝒈𝒔 𖣂
 '..msgs..' .\n- 🇪🇬 𝒔𝒕𝒂𝒔𝒕 𖣂 '..msg.TheRank..' .\n- 🇪🇬 𝒊𝒅 𖣂 '..msg.sender_user_id_..' \n- 🇪🇬 𝒄𝒉 𖣂 @FlassTas10 .',dl_cb,nil)
		else
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(Alamy..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(Alamy..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(Alamy..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(Alamy..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(Alamy..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(Alamy..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(Alamy..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(Alamy..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(Alamy..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
redis:del(Alamy..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
return "➪ **تم مسح {* "..msgs.." *} من رسائلك .\n"
end

if MsgText[1]== 'جهاتي' then
return '➪ **  عدد جهاتك المضافة‏‏ ⇜ ❪ '..(redis:get(Alamy..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n.'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'جهاتي'  then
local adduser = redis:get(Alamy..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "➪ **عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(Alamy..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
...
local points = redis:get(Alamy..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
if points == 0 then  return "➪ **عذرا ليس لديك نقاط لكِ يتم مسحها" end
redis:del(zoro..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:del(Alamy..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:del(Alamy..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:del(Alamy..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:del(Alamy..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:del(Alamy..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:del(Alamy..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:del(Alamy..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:del(Alamy..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:del(Alamy..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
if not msg.Admin then return "➪ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:set(Alamy..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Admin then return "➪ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if redis:get(Alamy..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(Alamy..'welcome:msg'..msg.chat_id_))
else 
return "➪ **أهلا عزيزي "..msg.TheRankCmd.."  \n➪ نورت المجموعه \n" 
end 
end
...
local groups = redis:smembers(Alamy..'group:ids')
...
local pv = redis:smembers(zoro..'users')
local NumPvDel = 0
for i = 1, #pv do
...
redis:setex(zoro..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(Alamy..':WELCOME_BOT')
if Photo_Weloame then
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[➪ اهلا انا بوت]]..redis:get(Alamy..':NameBot:')..[[ .
...
redis:setex(zoro..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '➪ حسننا عزيزي .\n➪ الان قم بارسال الكليشه \n' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(Alamy..':addnumberusers',MsgText[2]) 
return '➪ ** تم وضـع شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..MsgText[2]..'】* عضـو  .\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'➪ ** شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..redis:get(Alamy..':addnumberusers')..'】* عضـو .\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات ➪" then
if not msg.SudoUser then return "➪ **هذا الامر يخص {المطور} فقط  \n" end
return '➪ ** عدد المجموعات المفعلة » `'..redis:scard(Alamy..'group:ids')..'`  ➼' 
end

if MsgText[1] == "المشتركين" or MsgText[1] == "المشتركين ➪" then
if not msg.SudoUser then return "➪ **هذا الامر يخص {المطور} فقط  \n" end
return '➪ **عدد المشتركين في البوت : `'..redis:scard(Alamy..'users')..'` \n'
end
...
if not msg.SudoUser then return "➪ **هذا الامر يخص {المطور} فقط  \n" end
if redis:sismember(Alamy..'group:ids',MsgText[2]) then
local name_gp = redis:get(zoro..'group:name'..MsgText[2])
...
return redis:get(Alamy..":TEXT_SUDO") or '➪ لا توجد كليشه المطور .\n➪ يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n'
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه ➪" then
if not msg.SudoUser then return"➪ **هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(Alamy..'lock_brod') then 
return "➪ ** الاذاعه مقفوله من قبل المطور الاساسي  ." 
end
redis:setex(Alamy..'fwd:'..msg.sender_user_id_,300, true) 
...
redis:setex(Alamy..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(Alamy..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(Alamy..'fwd:groups'..msg.sender_user_id_,300, true) 
...
redis:del(Alamy..'welcom:witting'..msg.sender_user_id_,
Alamy..'rulse:witting'..msg.sender_user_id_,
Alamy..'rulse:witting'..msg.sender_user_id_,
Alamy..'name:witting'..msg.sender_user_id_,
Alamy..'about:witting'..msg.sender_user_id_,
Alamy..'fwd:all'..msg.sender_user_id_,
Alamy..'fwd:pv'..msg.sender_user_id_,
Alamy..'fwd:groups'..msg.sender_user_id_,
Alamy..'namebot:witting'..msg.sender_user_id_,
Alamy..'addrd_all:'..msg.sender_user_id_,
Alamy..'delrd:'..msg.sender_user_id_,
Alamy..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_,
Alamy..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,
Alamy..'addrd:'..msg.sender_user_id_,
Alamy..'delrdall:'..msg.sender_user_id_,
Alamy..":ForceSub:"..msg.sender_user_id_,
Alamy..'text_sudo:witting'..msg.sender_user_id_,
Alamy..'addrd:'..msg.chat_id_..msg.sender_user_id_,
Alamy..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
redis:set(Alamy..":VERSION",GetVerison)
return false
else
...
return 'ٴ𐄬 اصدار سورس العالمي : *v'..version..'* \n'
end
...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/FlassTas10"}}}
send_key(msg.sender_user_id_,'   [قناة سورس :  العالمي](https://t.me/FlassTas10)' ,nil,inline,msg.id_)
return false
end

if (MsgText[1]== "الاحصائيات ➪" or MsgText[1]=="الاحصائيات") then
if not msg.SudoBase then return"➪ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
return '➪ الاحصائيات . \n\n➪ **عدد المجموعات المفعله : '..redis:scard(Alamy..'group:ids')..'\n➪ **عدد المشتركين في البوت : '..redis:scard(Alamy..'users')..'\n'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام ➪" then
if not msg.SudoBase then return"➪ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(Alamy..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(Alamy..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
return "➪ حسننا الان ارسل كلمة الرد العام .\n"
end

if MsgText[1]== 'مسح' and MsgText[2]== 'الردود' then
if not msg.Director then return "➪ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names 	= redis:exists(Alamy..'replay:'..msg.chat_id_)
local photo 	= redis:exists(Alamy..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(Alamy..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(Alamy..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(Alamy..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(Alamy..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(Alamy..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(zoro..'replay:'..msg.chat_id_,zoro..'replay_photo:group:'..msg.chat_id_,zoro..'replay_voice:group:'..msg.chat_id_,
zoro..'replay_animation:group:'..msg.chat_id_,Alamy..'replay_audio:group:'..msg.chat_id_,Alamy..'replay_sticker:group:'..msg.chat_id_,Alamy..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:exists(Alamy..'replay:all')
local photo 	= redis:exists(Alamy..'replay_photo:group:')
local voice 	= redis:exists(Alamy..'replay_voice:group:')
local imation 	= redis:exists(Alamy..'replay_animation:group:')
local audio 	= redis:exists(Alamy..'replay_audio:group:')
local sticker 	= redis:exists(Alamy..'replay_sticker:group:')
local video 	= redis:exists(Alamy..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(Alamy..'replay:all',Alamy..'replay_photo:group:',Alamy..'replay_voice:group:',Alamy..'replay_animation:group:',Alamy..'replay_audio:group:',Alamy..'replay_sticker:group:',Alamy..'replay_video:group:')
...
if not msg.SudoBase then return"➪ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:set(zoro..'delrdall:'..msg.sender_user_id_,true) 
return "➪ حسننا عزيزي  .\n➪ الان ارسل الرد لمسحها من  المجموعات ."
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "➪ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:set(Alamy..'delrd:'..msg.sender_user_id_,true)
return "➪ حسننا عزيزي  .\n➪ الان ارسل الرد لمسحها من  للمجموعه ."
end

if MsgText[1]== 'الردود' then
if not msg.Director then return "➪ *│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names  	= redis:hkeys(Alamy..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(Alamy..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(Alamy..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(Alamy..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(Alamy..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(Alamy..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(Alamy..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(Alamy..'replay:all')
local photo 	= redis:hkeys(Alamy..'replay_photo:group:')
local voice 	= redis:hkeys(Alamy..'replay_voice:group:')
local imation 	= redis:hkeys(Alamy..'replay_animation:group:')
local audio 	= redis:hkeys(Alamy..'replay_audio:group:')
local sticker 	= redis:hkeys(Alamy..'replay_sticker:group:')
local video 	= redis:hkeys(Alamy..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '➪ **لا يوجد ردود مضافه حاليا \n' 
end
local ii = 1
...
if not msg.Director then return "➪ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(Alamy..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(Alamy..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "➪ حسننا , الان ارسل كلمه الرد \n"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"• **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(Alamy..'namebot:witting'..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "➪ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n➪ " end
if not redis:get(Alamy..'lave_me'..msg.chat_id_) then
return "➪ **أهلا عزيزي "..msg.TheRankCmd.."\n➪ ** المغادره بالتاكيد تم تفعيلها\n✓" 
else 
redis:del(Alamy..'lave_me'..msg.chat_id_) 
return "➪ **أهلا عزيزي "..msg.TheRankCmd.."\n➪ ** تم تفعيل المغادره \n✓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "➪ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n➪ " end
if redis:get(Alamy..'lave_me'..msg.chat_id_) then 
return "➪ **أهلا عزيزي "..msg.TheRankCmd.."\n➪ ** المغادره من قبل البوت بالتأكيد معطله\n✓" 
else
redis:set(Alamy..'lave_me'..msg.chat_id_,true)  
...
⌔︙-[𝒅𝒆𝒗 𖤍](t.me/XxxMohamed_AlgbrootxxX)

⌔︙-[𝒅𝒆𝒗 𖤍](t.me/XxxMalificentxxX) 

⌔︙-[𝘚𝘖𝘜𝘙𝘊𝘌 𝘈𝘓𝘈𝘔𝘠 𓁻](t.me/FlassTas10)

⌔︙-[𝑻𝑾𝑨𝑺𝑶𝑳 𖡛](t.me/FlassTas4_bot)
]]
end
...
if not msg.SudoBase then return"• **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local SubDel = redis:del(zoro..":UserNameChaneel")
if SubDel == 1 then
...
if not msg.SudoBase then return"➪ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(Alamy..":ForceSub:"..msg.sender_user_id_,350,true)
return "Alamy مرحبا بـك في نظام الاشتراك الاجباري\n➪ الان ارسل معرف قـنـاتـك"
end
...
if redis:get(Alamy..'welc'..msg.chat_id_) == 'on' then
...
local hash = zoro..'user_names:'..msg.sender_user_id_
redis:set(hash,info)
end
...
mmd = redis:get(Alamy..'addcmd'..msg.chat_id_..msg.sender_user_id_)
if mmd then
redis:sadd(Alamy..'CmDlist:'..msg.chat_id_,msg.text)
redis:hset(Alamy..'CmD:'..msg.chat_id_,msg.text,mmd)
sendMsg(msg.chat_id_,msg.id_,'➪ اهلا عزيزي \n➪ تم تثبيت الامر الجديد\n✓')
redis:del(Alamy..'addcmd'..msg.chat_id_..msg.sender_user_id_)
end

if Black:match('تغير امر (.*)') then
if not msg.Kara then return "➪ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = Black:match('تغير امر (.*)') 
redis:setex(Alamy..'addcmd'..msg.chat_id_..msg.sender_user_id_,120,cmd)
...
redis:hdel(Alamy..'CmD:'..msg.chat_id_,cmd)
redis:srem(Alamy..'CmDlist:'..msg.chat_id_,cmd)
sendMsg(msg.chat_id_,msg.id_,"➪ اهلا عزيزي\nالامر >"..cmd.."\n➪ تم مسحه من قائمه الاوامر\n")
end
if Black == 'مسح قائمه الاوامر' or Black == 'مسح قائمه الاوامر' then
if not msg.Kara then return "➪ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
redis:del(Alamy..'CmD:'..msg.chat_id_)
redis:del(Alamy..'CmDlist:'..msg.chat_id_)
sendMsg(msg.chat_id_,msg.id_,"➪ اهلا عزيزي تم مسح قائمه الاوامر")
end
if Black == "قائمه الاوامر" then
if not msg.Kara then return "➪ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local CmDlist = redis:smembers(Alamy..'CmDlist:'..msg.chat_id_)
local t = '➪ قائمه الاوامر : \n'
for k,v in pairs(CmDlist) do
mmdi = redis:hget(Alamy..'CmD:'..msg.chat_id_,v)
t = t..k..") "..v.." > "..mmdi.."\n" 
end
if #CmDlist == 0 then
...
redis:set(zoro..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل الترحيب' then
if redis:get(Alamy..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب سابقا')
redis:set(Alamy..'welc'..msg.chat_id_,'off')
redis:del(Alamy..'welc'..msg.chat_id_,'on')
else
...
function tophoto(kara,Alamy)   
if zoro.content_.ID == "MessageSticker" then        
local bd = zoro.content_.sticker_.sticker_.path_          
...
local msg_pv = tonumber(redis:get(Alamy..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(Alamy..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*➪ * تم حظرك من البوت بسبب التكرار \n') 
end
redis:setex(Alamy..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end

if msg.text=="/start" then 

if msg.SudoBase then
local text = '- شكراً لك لإستخدام سورس العالمي  و\n- أنت المطور الاساسي هنا\n—————————\n\n- يمكنك الأن التحكم بأوامر البوت عن طريق لوحة التحكم بالبوت\nفقط انقر على الأمر الذي اريده‏'
local keyboard = {
...
redis:sadd(Alamy..'users',msg.sender_user_id_)
if redis:get(zoro..'lock_service') then 
text = [[• أهلاً انا بوت   []]..redis:get(Alamy..':NameBot:')..[[] ➪
...
local MSG_ID = (redis:get(Alamy.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
redis:setex(Alamy.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
--====================== Reply Only Group ====================================
if redis:get(Alamy..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(Alamy..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(Alamy..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.text then 
redis:hset(Alamy..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
redis:del(Alamy..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n➪ تم اضافت الرد . \n-')
elseif msg.photo then 
redis:hset(Alamy..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(Alamy..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'➪ تم اضافه صوره للرد بنجاح\n➪ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(Alamy..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(Alamy..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'➪ تم اضافه بصمه صوت للرد بنجاح\n➪ يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(Alamy..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(Alamy..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'➪ تم اضافه متحركه للرد بنجاح\n➪ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(Alamy..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(Alamy..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'➪ تم اضافه فيديو للرد بنجاح\n➪ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(Alamy..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(Alamy..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'➪ تم اضافه للصوت للرد بنجاح\n➪ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(Alamy..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(Alamy..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(Alamy..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(Alamy..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(Alamy..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.text then
redis:hset(Alamy..'replay:all',klma,Flter_Markdown(msg.text))
redis:del(Alamy..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  • تم اضافت الرد لكل المجموعات . ')
elseif msg.photo then 
redis:hset(Alamy..'replay_photo:group:',klma,photo_id)
redis:del(Alamy..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'➪ تم اضافه صوره للرد العام\n➪ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(Alamy..'replay_voice:group:',klma,voice_id)
redis:del(zoro..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'➪ تم اضافه بصمه صوت للرد العام\n➪ يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(Alamy..'replay_animation:group:',klma,animation_id)
redis:del(Alamy..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'➪ تم اضافه متحركه للرد العام\n➪ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(Alamy..'replay_video:group:',klma,video_id)
redis:del(Alamy..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'➪ تم اضافه فيديو للرد العام\n➪ يمكنك ارسال ❴ ['..klma..'] ❵لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(Alamy..'replay_audio:group:',klma,audio_id)
redis:del(Alamy..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'➪ تم اضافه للصوت للرد العام\n➪ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(Alamy..'replay_sticker:group:',klma,sticker_id)
redis:del(Alamy..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(Alamy..":ForceSub:"..msg.sender_user_id_) then
if msg.text:match("^@[%a%d_]+$") then
redis:del(Alamy..":ForceSub:"..msg.sender_user_id_)
...
redis:set(Alamy..":UserNameChaneel",msg.text)
...
if redis:get(Alamy..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(Alamy..'namebot:witting'..msg.sender_user_id_)
redis:set(Alamy..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"➪ تم تغير اسم البوت  .\n➪ الان اسمه "..Flter_Markdown(msg.text).." \n")
return false
end

if redis:get(Alam..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(Alamy..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
redis:hdel(Alamy..'replay_photo:group:',msg.text)
redis:hdel(Alamy..'replay_voice:group:',msg.text)
redis:hdel(Alamy..'replay_animation:group:',msg.text)
redis:hdel(Alamy..'replay_audio:group:',msg.text)
redis:hdel(Alamy..'replay_sticker:group:',msg.text)
redis:hdel(Alamy..'replay_video:group:',msg.text)
redis:setex(Alamy..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"➪ جيد , يمكنك الان ارسال جوا ب الردالعام \n➪ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(Alamy..'delrdall:'..msg.sender_user_id_) then
redis:del(Alamy..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(Alamy..'replay:all',msg.text)
local photo =redis:hget(Alamy..'replay_photo:group:',msg.text)
local voice = redis:hget(Alamy..'replay_voice:group:',msg.text)
local animation = redis:hget(Alamy..'replay_animation:group:',msg.text)
local audio = redis:hget(Alamy..'replay_audio:group:',msg.text)
local sticker = redis:hget(Alamy..'replay_sticker:group:',msg.text)
local video = redis:hget(Alamy..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'➪ **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(Alamy..'replay:all',msg.text)
redis:hdel(Alamy..'replay_photo:group:',msg.text)
redis:hdel(Alamy..'replay_voice:group:',msg.text)
redis:hdel(Alamy..'replay_audio:group:',msg.text)
redis:hdel(Alamy..'replay_animation:group:',msg.text)
...
if redis:get(zoro..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(zoro..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(zoro..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "➪ ** تم وضع الكليشه بنجاح كلاتي .\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n")
end
if redis:get(Alamy..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(Alamy..'welcom:witting'..msg.sender_user_id_) 
redis:set(Alamy..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"➪ ** تم وضع الترحيب بنجاح كلاتي .\n" )
end
if redis:get(Alamy..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(Alamy..'rulse:witting'..msg.sender_user_id_) 
redis:set(Alamy..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'➪ ** مرحبآ عزيزي\n➪ تم حفظ القوانين بنجاح .\n➪ ارسل [[ القوانين ]] لعرضها \n')
end
if redis:get(Alamy..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(Alamy..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(Alamy..'linkGroup'..msg.sender_user_id_,link) then --- استقبال الرابط
redis:del(Alamy..'linkGroup'..msg.sender_user_id_,link) 
redis:set(Alamy..'linkGroup'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'➪ تم وضع الرابط الجديد بنجاح .. 🍂')
end
if redis:get(Alamy..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(Alamy..'about:witting'..msg.sender_user_id_) 
...
if redis:get(Alamy..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(zoro..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(Alamy..'users')  
local groups = redis:smembers(Alamy..'group:ids')
...
if redis:get(Alamy..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(zoro..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(Alamy..'users')
if #pv >= 300 then
...
if redis:get(Alamy..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(Alamy..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(Alamy..'group:ids')
if #groups >= 300 then
...
if msg.adduser and msg.adduser == our_id and redis:get(Alamy..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(zoro..':WELCOME_BOT'),[[➪أهلاً انا بوت ]]..redis:get(zoro..':NameBot:')..[[
➪ أختصاصي حماية‌‏ المجموعات
➪ مـن السبام والتوجيه‌‏ والتكرار والخ...
➪ السورس @FlassTas10

➪ المعرف الـمـطـور  : ]]..SUDO_USER:gsub([[\_]],'_')..[[
]])
return false
end 

if msg.forward_info and redis:get(Alamy..'fwd:'..msg.sender_user_id_) then
redis:del(Alamy..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(Alamy..'users')
local groups = redis:smembers(Alamy..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(Alamy..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(zoro..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(Alamy..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,'➪ تم تغيير صوره‏‏ الترحيب للبوت .\n')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(Alamy..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(Alamy..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
if redis:get(Alamy..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(Alamy..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
redis:hdel(Alamy..'replay:'..msg.chat_id_,msg.text)
redis:hdel(Alamy..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(Alamy..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(Alamy..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(Alamy..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(Alamy..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(Alamy..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(Alamy..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"➪ جيد , يمكنك الان ارسال جواب الرد \n➪ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(Alamy..'delrd:'..msg.sender_user_id_) then
redis:del(Alamy..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(Alamy..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(Alamy..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(Alamy..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(Alamy..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(Alamy..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(Alamy..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(Alamy..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'➪ **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(Alamy..'replay:'..msg.chat_id_,msg.text)
...
if msg.pinned then
print(" -- pinned -- ")
local msg_pin_id = redis:get(Alamy..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and redis:get(Alamy..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(Alamy..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(Alamy..'group:name'..msg.chat_id_,msg.content_.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
if redis:get(Alamy..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
else
if redis:get(Alamy..'welcome:get'..msg.chat_id_) then 
if not msg.adduserType then
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(Alamy..'welcome:msg'..msg.chat_id_) or "➪ اهلاً عزيزي {الاسم}\n➪ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n➪ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(Alamy..'rulse:msg'..msg.chat_id_) or "➪ مرحباً عزيري القوانين كلاتي .\n➪ ممنوع نشر الروابط\n➪ ممنوع التكلم او نشر صور اباحيه\n➪ ممنوع  اعاده توجيه\n➪ ممنوع التكلم بالسياسة\n➪ الرجاء احترام المدراء والادمنيه .\n")
welcome = welcome:gsub("{القوانين}", rules)
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(zoro..'group:name'..msg.chat_id_) or '')))
...
welcome = (redis:get(zoro..'welcome:msg'..msg.chat_id_) or "➪ اهلن بك عزيزي {الاسم}\n➪ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n➪ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(Alamy..'rulse:msg'..msg.chat_id_) or "➪ مرحباً عزيري القوانين كلاتي .\n➪ ممنوع نشر الروابط\n➪ ممنوع التكلم او نشر صور اباحيه\n➪ ممنوع  اعاده توجيه\n➪ ممنوع التكلم بالسياسة\n➪ الرجاء احترام المدراء والادمنيه\n")
welcome = welcome:gsub("{القوانين}", rules)
if msg.addusername then UserName = '@'..msg.addusername else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(Alamy..'group:name'..msg.chat_id_) or '')))
local welcome = welcome:gsub("{المعرف}",UserName)
...
--------------------------------------------
if msg.adduser and redis:get(Alamy..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(Alamy..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(Alamy..'welcome:get'..msg.chat_id_)
end
redis:setex(Alamy..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if not msg.Admin and not msg.Special and not (msg.adduser or msg.joinuser or msg.deluser ) then -- للاعضاء فقط   

if not msg.forward_info and redis:get(Alamy..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(Alamy..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_Alamy = (redis:get(Alamy..'num_msg_Alamy'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_zoro) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(Alamy..'sender:'..msg.sender_user_id_..':flood',30,true)
if datau.username_ then USERNAME = '@'..datau.username_ else USERNAME = FlterName(datau.first_name_..' '..(datau.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,datau.id_,msg.id_,"➪ العضو » "..USERNAME.."\n• قمـت بتكرار اكثر مـن "..NUM_MSG_Alamy.." رسالة‌‏ , لذا تم تقييدك مـن المجموعه‌\n",12,USERCAR) 
return false
end)
end 
redis:setex(Alamy..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end
...
if redis:get(Alamy..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(Alamy..'lock_woring'..msg.chat_id_) and not redis:get(Alamy..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(Alamy..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(Alamy..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(Alamy..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(Alamy..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(Alamy..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(Alamy..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(Alamy..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(Alamy..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(Alamy..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(Alamy..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(Alamy..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(Alamy..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(Alamy..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.photo then
if redis:get(Alamy..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(Alamy..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.video then
if redis:get(Alamy..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(Alamy..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(Alamy..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.sticker and redis:get(zoro..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.animation then
if redis:get(Alamy..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(Alamy..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(Alamy..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(Alamy..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(Alamy..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(Alamy..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(Alamy..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(Alamy..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(zoro..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(Alamy..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(Alamy..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(Alamy..'replay'..msg.chat_id_) then

local Replay = false

 Replay = redis:hget(Alamy..'replay:all',msg.text)
if Replay then
sendMsg(msg.chat_id_,msg.id_,Replay)
return false
end

 Replay = redis:hget(Alamy..'replay:'..msg.chat_id_,msg.text)
if Replay then 
 sendMsg(msg.chat_id_,msg.id_,Replay) 
return false
end
 Replay = redis:hget(Alamy..'replay_photo:group:',msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Alamy..'replay_voice:group:',msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(Alamy..'replay_animation:group:',msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Alamy..'replay_audio:group:',msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Alamy..'replay_sticker:group:',msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Alamy..'replay_video:group:',msg.text)
if Replay then 
print("0000000000000") 
...
Replay = redis:hget(Alamy..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Alamy..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(Alamy..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Alamy..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Alamy..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Alamy..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVideo(msg.chat_id_,msg.id_,Replay)
return false
end
...
elseif Text== "العالمي" or Text== "العالمي" then return  sendMsg(msg.chat_id_,msg.id_,"[ملك التلجرام ➪](https://t.me/Alamy3)")
elseif Text== "ملك التلجرام" or Text== "مطور السورس" then return  sendMsg(msg.chat_id_,msg.id_,"[الجبروت](https://t.me/XxxMohamed_AlgbrootxxX)")
elseif Text==  "رفع قرد"  then return sendMsg(msg.chat_id_,msg.id_,"ٴ𐄬 أهلاً عزيزي\nٴ𐄬 تم رفع قرد بنجاح↯\nٴ𐄬 تمت إضافته إلى قائمه القرود\n➪")
elseif Text== "تنزيل قرد"  then return sendMsg(msg.chat_id_,msg.id_,"ٴ𐄬 أهلاً عزيزي\nٴ𐄬 تم تنزيل قرد بنجاح↯\nٴ𐄬 تمت الزاله من قائمه القرود\n➪")
...
ٴ➪ Source Alamy ➪
 ➪ رابط حذف  [Telegram](https://my.telegram.org/auth?to=delete) ܁
  ...
  --=====================================
  elseif Text== "العالمي" or Text== " فلسطس " or Text=="Alamy" then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس.](https://t.me/Alamy3) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس.](https://t.me/Alamy3")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس.](https://t.me/Alamy3")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس.](https://t.me/@XxxMohamed_AlgbrootxxX")
else 
return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس.](https://t.me/@XxxMalificentxxX")
end 
end 
...
if not redis:get('kar') then
  ...
  json_data = '{"BotID": '..zoro..',"UserBot": "'..Bot_User..'","Groups" : {'
  ...
  local admins = redis:smembers(Alamy..'admins:'..GroupS)
  if #admins ~= 0 then
  json_data =  json_data..',"Admins" : {'
  for key,value in pairs(admins) do
  local info = redis:hgetall(Alamy..'username:'..value)
  if info then 
  ...
  local creators = redis:smembers(Alamy..':MONSHA_BOT:'..GroupS)
  if #creators ~= 0 then
  ...
  local creator = redis:smembers(Alamy..':KARA_BOT:'..GroupS)
  if #creator ~= 0 then
  ...
  local owner = redis:smembers(Alamy..'owners:'..GroupS)
  if #owner ~= 0 then
  ...
  if redis:get(Alamy..'CheckExpire::'..msg.chat_id_) then
  local ExpireDate = redis:ttl(Alamy..'ExpireDate:'..msg.chat_id_)
  if not ExpireDate and not msg.SudoUser then
  rem_data_group(msg.chat_id_)
  sendMsg(SUDO_ID,0,'➪ انتهى الاشتراك في احد المجموعات .\n➪ المجموعه : '..FlterName(redis:get(zoro..'group:name'..msg.chat_id_))..'.\n➪ ايدي : '..msg.chat_id_)
  sendMsg(msg.chat_id_,0,'➪ انتهى الاشتراك البوت.\n➪ سوف اغادر المجموعه فرصه سعيده .\n➪ او راسل المطور للتجديد '..SUDO_USER..' 🍃')
  return StatusLeft(msg.chat_id_,our_id)
  else
  local DaysEx = (redis:ttl(Alamy..'ExpireDate:'..msg.chat_id_) / 86400)
