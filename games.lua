--[[
الالعاب ل سورس العالمي
تم تعديل الملف واضافه الالعاب من قبل العالمي فوو (@Alamy3)
--]]
...
return 'اول من يكتب هذا العدد يفوز ↤︎`'..(redis:get(Alamy..':Set_Smile:'..msg.chat_id_))..'`'
else
return '️اول من يكتب هذه السمايل يفوز ↤︎    `'..(redis:get(Alamy..':Set_Smile:'..msg.chat_id_))..'`'
end
end
...
redis:set(zoro.."GAME:S"..msg.chat_id_,true) 
H1 = [[
• عكس كلمه » {مافهمت} .
]]
H2 = [[
...
redis:set(Alamy.."GAME:CHER"..msg.chat_id_,'شجاع') 
elseif SENDTEXT:find('حي') then
redis:set(Alamy.."GAME:CHER"..msg.chat_id_,'حي') 
elseif SENDTEXT:find('نشيط') then
redis:set(Alamy.."GAME:CHER"..msg.chat_id_,'نشيط') 
...
redis:set(Alamy.."GAME:CHER"..msg.chat_id_,'مو ممنوع') 
...
return "➪ تم خصم {* "..MsgText[2].." *} من نقاطك\n➪ تم زياده {* "..Total_Point.."* } من الرسائل \n➪ اصبحت رسائلك { *"..redis:get(zoro..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_).."* } رساله\n• "
end
end
if MsgText[1] == "الالعاب" or MsgText[1] == "اللعبه" or MsgText[1] == "اللعبة" then
return [[ 
➪ الالعاب لبوت []]..redis:get(Alamy..':NameBot:')..[[]   ،  🎖 الالعاب بسورس العالمي ➪
...
redis:del(Alamy3..':Set_alii:'..msg.chat_id_)
...
redis:set(zoro..":Number_Add:"..msg.chat_id_..msg.sender_user_id_,msg.text)  
Text = '• تم بدء تسجيل اللسته \n• يرجى ارسال المعرفات \n• الفائز يحصل على (5) مجوهره\n• عدد الاعبين المطلوبه { *'..msg.text..'* } لاعب \n'
end
redis:del(zoro..":Start_Rolet:"..msg.chat_id_..msg.sender_user_id_)  
return sendMsg(msg.chat_id_,msg.id_,Text)    
end
if msg.text:match('^(@[%a%d_]+)$') and redis:get(zoro..":Number_Add:"..msg.chat_id_..msg.sender_user_id_) then    --// استقبال الاسماء
